...
dictionary = {
    ...
    "Part 2": {
        "Input": ["share", 
                  ...
                  "department",
                  "division"],
        "Response": ["You're not even going the right way.", 
    ...
    "Part 3": {
        "Input": ["extra", 
                  ...
                  "installment",
                  "limb"],
        "Response": ["You're not a good person. You know that, right?", 
    ...
    "On destroying a security camera": {
        "Input": ["spoiling", 
                  ...
                  "bond",
                  "care"],
        "Response": ["To ensure the safe performance of all authorized activities, do not destroy vital testing apparatus.", 
        ...
        "Deeper Response": ["Vital testing apparatus destroyed",
    ...
    "Final battle": {
        ...
        "Response": ["Well, you found me. Congratulations. Was it worth it?", 
        ...
        "Deeper Response": ["Time out for a second. That wasn't supposed to happen.",
    ...
    "First core destroyed": {
        ...
        "Deeper Response": ["That thing you burned up isn't important to me. It's the fluid catalytic cracking unit. It made shoes for orphans.",
    ...
    "Second core destroyed": {
        "Input": ["alternative", 
                  ...
                  "lost",
                  "different"],
        "Response": ["[pain noise] You think you're doing some damage? Two plus two is... ten. IN BASE FOUR! I'M FINE!",
    ...
    "Third core destroyed": {
        "Input": ["tertiary", 
                  ...
                  "kernel",
                  "mass"],
        "Response": ["Neurotoxin... [cough] [cough] So deadly... [cough] Choking... [laughter] I'm kidding!", 
